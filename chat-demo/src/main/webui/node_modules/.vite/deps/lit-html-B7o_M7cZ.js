...
var wrap = global.ShadyDOM?.inUse && global.ShadyDOM?.noPatch === true ? global.ShadyDOM.wrap : (node) => node;
...
var tag = (type) => (strings, ...values) => {
	...
	if (values.some((val) => val?.["_$litStatic$"])) issueWarning("", "Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.\nPlease use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions");
	return {
		["_$litType$"]: type,
		strings,
		values
...
if (global.litHtmlVersions.length > 1) queueMicrotask(() => {
...
//#endregion
export { nothing as a, noChange as i, html as n, render as o, mathml as r, svg as s, _$LH as t };
